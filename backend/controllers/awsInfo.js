...
awsInfoRouter.post('/mesh-details', async (request, response) => {
  try {
...
awsInfoRouter.post('/ecs-details', async (request, response) => {
...
awsInfoRouter.post('/cw-metric-namespace', async (request, response) => {
  try {
...
awsInfoRouter.post('/ecs-services', async (request, response) => {
